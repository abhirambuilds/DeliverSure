...
@router.get('/claims')
def admin_list_claims(authorization: str = Header(...)):
    verify_token(authorization)
...
def admin_approve_claim(claim_id: str, authorization: str = Header(...)):
    verify_token(authorization)
